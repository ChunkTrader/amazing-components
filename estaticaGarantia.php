...
$regMem->setValor('titulo', 'Garantia');
...
<div id="main">
	...
	<div id="main-content">
		...
		<div class="separacion">
			...
			<h3 class="separacion">Garantías de Productos</h3>
			...
			<h3 class="separacion">Garantía de dos años mínimo desde la entrega en todos los productos</h3>
			...
			<h3 class="separacion">Anulación de garantias</h3>
